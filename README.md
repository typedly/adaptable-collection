<a href="https://github.com/typescript-package">
  <img
    ...
    title="@typedly/adaptable-collection - A TypeScript type definitions package for adaptable data collections with configuration, adapter support."
  />
</a>

## @typedly/adaptable-collection
...
A **TypeScript** type definitions package for adaptable data collections with configuration, adapter support based on [`@typedly/configurable-collection`](https://github.com/typedly/configurable-collection).
...
- **Shape**: The shape of element-based collection built on [`@typedly/configurable-collection`](https://github.com/typedly/configurable-collection).
...
The constructor type for `AdaptableCollectionShape`, which defines the structure for creating instances of adaptable collections that can adapt to different collection shapes and settings.

```typescript
import { AdaptableCollectionConstructor } from '@typedly/adaptable-collection';
```
...
<!-- This package: typedly  -->
  <!-- GitHub: badges -->
  [package-badge-issues]: https://img.shields.io/github/issues/typedly/adaptable-collection
  [package-badge-forks]: https://img.shields.io/github/forks/typedly/adaptable-collection
  [package-badge-stars]: https://img.shields.io/github/stars/typedly/adaptable-collection
  [package-badge-license]: https://img.shields.io/github/license/typedly/adaptable-collection
  <!-- GitHub: badges links -->
  [package-issues]: https://github.com/typedly/adaptable-collection/issues
  [package-forks]: https://github.com/typedly/adaptable-collection/network
  [package-license]: https://github.com/typedly/adaptable-collection/blob/master/LICENSE
  [package-stars]: https://github.com/typedly/adaptable-collection/stargazers
<!-- This package -->

<!-- Package: typedly -->
  <!-- npm -->
  [package-npm-badge-svg]: https://badge.fury.io/js/@typedly%2Fadaptable-collection.svg
  [package-npm-badge]: https://badge.fury.io/js/@typedly%2Fadaptable-collection
